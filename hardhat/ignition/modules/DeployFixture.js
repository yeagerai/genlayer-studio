...
module.exports = buildModule("DeployFixture", (m) => {
  ...
  const initConsensusMain = m.call(
    ConsensusMain,
    "initialize",
    [ConsensusManager],
    {
  ...
  const setGenTransactions = m.call(
    ConsensusMain,
    "setGenTransactions",
    [Transactions],
    {
  ...
  const initConsensusData = m.call(
    ConsensusData,
    "initialize",
    [ConsensusMain, Transactions, Queues],
    {
  ...
  const setGenConsensusByGhostFactory = m.call(
    GhostFactory,
    "setGenConsensus",
    [ConsensusMain],
    {
  ...
  const setGhostManagerByGhostFactory = m.call(
    GhostFactory,
    "setGhostManager",
    [ConsensusMain],
    {
  ...
  const setGenConsensusByTransactions = m.call(
    Transactions,
    "setGenConsensus",
    [ConsensusMain],
    {
  ...
  const setGenConsensusByMessages = m.call(
    Messages,
    "setGenConsensus",
    [ConsensusMain],
    {
  ...
  const setGenTransactionsByMessages = m.call(
    Messages,
    "setGenTransactions",
    [Transactions],
    {
  ...
  const setAcceptanceTimeout = m.call(
    ConsensusMain,
    "setAcceptanceTimeout",
    [0],
    {
  ...
  const setGenAppealsByConsensusMain = m.call(
    ConsensusMain,
    "setGenAppeals",
    [Appeals],
    {
