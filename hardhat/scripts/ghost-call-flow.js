...
async function completeConsensusFlow(consensusMain, txId, ghostAddress, activator, validators, proposedReceipt = "0x1234", nonces) {
    ...
    const leader = validators.find(v => v.address === consensusMain.interface.parseLog(activationEvent).args[1]);
